  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-[var(--surface)] border p-4 text-center" style={{ borderColor: "var(--border)" }}>
          <p className="font-mono text-[10px] text-[color:var(--muted-2)] uppercase tracking-wider mb-1">Before Shock</p>
          <p className="font-mono font-bold text-lg text-text">
            ₹{result.portfolio_before.toFixed(0)}
          </p>
          <p className="font-mono text-[9px] text-[color:var(--muted)] uppercase">(normalised to 100)</p>
        </div>
        <div className="bg-red-500/5 border p-4 text-center" style={{ borderColor: "var(--bear-border)" }}>
          <p className="font-mono text-[10px] text-[color:var(--muted-2)] uppercase tracking-wider mb-1">After Shock</p>
        ...
        <div className="bg-[var(--surface)] border p-4 text-center" style={{ borderColor: "var(--border)" }}>
          <p className="font-mono text-[10px] text-[color:var(--muted-2)] uppercase tracking-wider mb-1">Nifty Drop</p>
          <p className="font-mono font-bold text-lg text-red-600">
            {result.nifty_drop.toFixed(1)}%
          </p>
          <p className="font-mono text-[9px] text-[color:var(--muted)] uppercase">Market benchmark</p>
        </div>
      </div>

      {/* Comparison */}
      <div className="bg-[var(--surface)] border px-4 py-3 flex items-center justify-between" style={{ borderColor: "var(--border)" }}>
        <div className="font-mono text-[10px] text-[color:var(--muted-2)] uppercase">
          <span className="font-bold text-text">Scenario:</span> {result.scenario}
        </div>
        <div className="flex gap-4 font-mono text-[10px] uppercase text-[color:var(--muted-2)]">
          <span>
      ...
      <div className="bg-[var(--surface)] border p-4" style={{ borderColor: "var(--border)" }}>
        <p className="font-mono text-[10px] font-bold text-[color:var(--muted)] mb-4 uppercase tracking-wider">Per-Stock Impact Breakdown</p>
